<?php 	//thx.php
	...
	$weekdayAction = array( //В настоящее время не используется - акция буднего дня
				'header' => 'флаер на бесплатное посещение',
				'condition' => 'по тарифам "Чайный" или "Кофейный" БЕСПЛАТНО в течение ближайших 7 дней по будням.
	...
	$weekendAction = array( //В настоящее время не используется - акция выходного дня
				'header' => 'флаер на скидку 50%',
				'condition' => 'по тарифам "Чайный" или "Кофейный" со скидкой 50% в течение ближайших 14 дней по выходным.
				Ваш флаер можно распечатать для предъявления на входе, 
				либо сохранить и показать с экрана мобильного телефона',
	...
	$all = array( //Универсальная акция (все дни)
				'header' => 'флаер на скидку 50%',
				'condition' => 'по тарифам "Чайный" или "Кофейный" со скидкой 50% в течение ближайших 7 дней.
				Ваш флаер можно распечатать для предъявления на входе, 
				либо сохранить и показать с экрана мобильного телефона',
				'tarif' => 'Билет действует с понедельника по воскресенье по тарифам "Чайный" или "Кофейный"',
				'notice' => 'посещение со скидкой 50%',
				'expire' => date("d.m.yг.", time() + 7*24*60*60)
		);
...
<html>
	<head>
		...
		<meta property="og:image" content='http://12komnat.com/img/logo.png' />
		<meta property="og:title" content='Бесплатное посещение Антикафе 12 Комнат' />
		<meta property="og:description" content='Получи флаер и приходи с друзьями в антикафе 12Комнат бесплатно. Тариф "Все включено"' />
		...
		<script type="text/javascript">
		  VK.init({apiId: 4429102, onlyWidgets: true});
		</script>
			...
			<section class="content">
				...
				<p>По данному флаеру Вы можете посетить антикафе "12 Комнат" 
					...
					<section class="adress_time">
						...
						<section id="vkLikeButton">
						
							<div id="vk_like"></div>

						</section>

						<section id="vkShareButton">
			...
			description: 'Получи флаер и приходи с друзьями в антикафе 12Комнат бесплатно. Тариф "Все включено"',
			 ...
			 noparse: true
						...
						VK.Widgets.Like("vk_like", {
							...
							type: "mini", 
							height: 24,
							pageUrl:'http://12komnat.com',
							text:"Я иду в Антикафе 12 комнат в СПб, кто со мной?"
